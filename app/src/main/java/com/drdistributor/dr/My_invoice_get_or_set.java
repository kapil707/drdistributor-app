...
public class My_invoice_get_or_set {
    private String item_id,item_title,item_message,item_date_time,item_image;
    public My_invoice_get_or_set() {
    }

    public My_invoice_get_or_set(String item_id, String item_title, String item_message, String item_date_time, String item_image,
