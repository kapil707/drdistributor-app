...
public class My_notification extends AppCompatActivity {
    ...
    ListView listview;
    My_notification_Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainurl = ma.main_url;
        page_url1 = mainurl + "my_notification_api/post";
        ...
        action_bar_title.setText("My Notifications");
        ...
        menu_search_div_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                in.setClass(My_notification.this, Medicine_search.class);
                startActivity(in);
                finish();
            }
        });
        ...
        cart_LinearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in = new Intent();
                in.setClass(My_notification.this, My_cart.class);
                startActivity(in);
                finish();
            }
        });
        ...
        adapter = new My_notification_Adapter(My_notification.this, My_notification_List);
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1,
                ...
                My_notification_get_or_set clickedCategory = My_notification_List.get(arg2);
                String item_id = clickedCategory.item_id();

                Intent open_page = new Intent();
                open_page.setClass(My_notification.this, My_notification_details.class);
        ...
        listview.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScroll(AbsListView view, int firstVisibleItem,
                ...
                if (firstVisibleItem + visibleItemCount == totalItemCount && totalItemCount != 0) {
                    if (query_work == 0) {
                        new json_My_notification().execute();
                    }
                }
            }
        });
    ...
    private class json_My_notification extends AsyncTask<Void, Void, Void> {
        @Override
        ...
        protected void onPostExecute(Void args) {
            ...
            try {
                if (!result.equals("")) {
                    ...
                    if (My_notification_List.isEmpty()) {
                ...
                Toast.makeText(getApplicationContext(), "error -- json_My_notification --" + e.toString(), Toast.LENGTH_LONG).show();
