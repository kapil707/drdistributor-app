...
public class My_order extends AppCompatActivity {
    ...
    List<My_order_get_or_set> My_order_List = new ArrayList<My_order_get_or_set>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainurl = ma.main_url;
        page_url1 = mainurl + "my_order_api/post";
        ...
        action_bar_title.setText("My orders");
        ...
        menu_search_div_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                in.setClass(My_order.this, Medicine_search.class);
                startActivity(in);
                finish();
            }
        });
        ...
        cart_LinearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in = new Intent();
                in.setClass(My_order.this, My_cart.class);
                startActivity(in);
                finish();
            }
        });
        ...
        adapter = new My_order_Adapter(My_order.this, My_order_List);
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1,
                ...
                My_order_get_or_set clickedCategory = My_order_List.get(arg2);
                String item_id = clickedCategory.item_id();

                Intent open_page = new Intent();
                open_page.setClass(My_order.this, My_order_details.class);
    ...
    private class json_My_order extends AsyncTask<Void, Void, Void> {
        @Override
            ...
            try {
                if (!result.equals("")) {
                    ...
                    for (int i = 0; i < jArray1.length(); i++) {
                        ...
                        My_order_get_or_set My_order_set = new My_order_get_or_set();
                        My_order_set.item_id(item_id);
                        My_order_set.item_title(item_title);
                        My_order_set.item_message(item_message);
                        My_order_set.item_date_time(item_date_time);
                        My_order_set.item_image(item_image);
                        My_order_List.add(My_order_set);
                    }
                    adapter.notifyDataSetChanged();
                    if (My_order_List.isEmpty()) {
                ...
                Toast.makeText(getApplicationContext(), "error -- json_My_order --" + e.toString(), Toast.LENGTH_LONG).show();
