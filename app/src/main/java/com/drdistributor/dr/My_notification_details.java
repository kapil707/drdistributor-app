...
public class My_notification_details extends AppCompatActivity {
    ...
    ListView listview;
    My_notification_details_Adapter adapter;
    List<My_notification_details_get_or_set> My_notification_details_List = new ArrayList<My_notification_details_get_or_set>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.my_notification_details);
        ...
        mainurl = ma.main_url;
        page_url1 = mainurl + "my_notification_details_api/post";
        ...
        action_bar_title.setText("My notification details");
        ...
        menu_search_div_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                in.setClass(My_notification_details.this, Medicine_search.class);
                startActivity(in);
                finish();
            }
        });
        ...
        cart_LinearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in = new Intent();
                in.setClass(My_notification_details.this, My_cart.class);
                startActivity(in);
                finish();
            }
        });
        ...
        adapter = new My_notification_details_Adapter(My_notification_details.this, My_notification_details_List);
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1,
                ...
                My_notification_details_get_or_set clickedCategory = My_notification_details_List.get(arg2);
                String item_fun_type = clickedCategory.item_fun_type();
                String item_fun_name = clickedCategory.item_fun_name();
                String item_fun_id = clickedCategory.item_fun_id();
                String item_fun_id2 = clickedCategory.item_fun_id2();

                if (item_fun_type.equals("1")) {
                    Intent open_page = new Intent();
                    open_page.setClass(My_notification_details.this, Medicine_details.class);
                    open_page.putExtra("item_code", item_fun_id);
                    startActivity(open_page);
                }

                if (item_fun_type.equals("2")) {
                    Intent open_page = new Intent();
                    open_page.setClass(My_notification_details.this, Medicine_category.class);
                    open_page.putExtra("item_code", item_fun_id);
                    if (item_fun_id2.equals("")) {
                        item_fun_id2 = "not";
                    }
                    open_page.putExtra("item_division", item_fun_id2);
                    open_page.putExtra("item_page_type", "medicine_category");
                    startActivity(open_page);
                }

                if (item_fun_type.equals("3")) {
                    Intent open_page = new Intent();
                    open_page.setClass(My_notification_details.this, Track_order_page.class);
                    open_page.putExtra("item_id", item_id);
                    startActivity(open_page);
                }

                if (item_fun_type.equals("4")) {
                    Intent open_page = new Intent();
                    open_page.setClass(My_notification_details.this, My_order.class);
                    startActivity(open_page);
                }

                if (item_fun_type.equals("5")) {
                    Intent open_page = new Intent();
                    open_page.setClass(My_notification_details.this, My_invoice.class);
                    startActivity(open_page);
                }
            }
        });
        ...
        new My_notification_details.json_My_notification_details().execute();
    }

    private class json_My_notification_details extends AsyncTask<Void, Void, Void> {
        @Override
        ...
        protected void onPostExecute(Void args) {
            ...
            My_notification_details_List.clear();
            ...
            try {
                if (!result.equals("")) {
                    ...
                    for (int i = 0; i < jArray1.length(); i++) {
                        ...
                        String item_image2 = jsonObject.getString("item_image2");
                        String item_fun_type = jsonObject.getString("item_fun_type");
                        String item_fun_name = jsonObject.getString("item_fun_name");
                        String item_fun_id = jsonObject.getString("item_fun_id");
                        String item_fun_id2 = jsonObject.getString("item_fun_id2");

                        My_notification_details_get_or_set My_notification_details_set = new My_notification_details_get_or_set();
                        My_notification_details_set.item_id(item_id);
                        My_notification_details_set.item_title(item_title);
                        My_notification_details_set.item_message(item_message);
                        My_notification_details_set.item_date_time(item_date_time);
                        My_notification_details_set.item_image(item_image);
                        My_notification_details_set.item_image2(item_image2);
                        My_notification_details_set.item_fun_type(item_fun_type);
                        My_notification_details_set.item_fun_name(item_fun_name);
                        My_notification_details_set.item_fun_id(item_fun_id);
                        My_notification_details_set.item_fun_id2(item_fun_id2);
                        My_notification_details_List.add(My_notification_details_set);
                    }
                    adapter.notifyDataSetChanged();
                    if (My_notification_details_List.isEmpty()) {
                ...
                Toast.makeText(getApplicationContext(), "error -- json_My_notification_details --" + e.toString(), Toast.LENGTH_LONG).show();
