...
public class My_order_details extends AppCompatActivity {
    ...
    ListView listview;
    My_order_details_Adapter adapter;
    List<My_order_details_get_or_set> My_order_details_List = new ArrayList<My_order_details_get_or_set>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainurl = ma.main_url;
        page_url1 = mainurl + "my_order_details_api/post";
        ...
        action_bar_title.setText("My order details");
        ...
        menu_search_div_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                in.setClass(My_order_details.this, Medicine_search.class);
                startActivity(in);
                finish();
            }
        });
        ...
        cart_LinearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in = new Intent();
                in.setClass(My_order_details.this, My_cart.class);
                startActivity(in);
                finish();
            }
        });
        ...
        adapter = new My_order_details_Adapter(My_order_details.this, My_order_details_List);
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1,
                ...
                My_order_details_get_or_set clickedCategory = My_order_details_List.get(arg2);
                String item_code = clickedCategory.item_code();

                Intent open_page = new Intent();
                open_page.setClass(My_order_details.this, Medicine_details.class);
        ...
        new json_My_order_details().execute();
    }

    private class json_My_order_details extends AsyncTask<Void, Void, Void> {
        @Override
            ...
            try {
                if (!result.equals("")) {
                    ...
                    for (int i = 0; i < jArray1.length(); i++) {
                        ...
                        My_order_details_get_or_set My_order_details_set = new My_order_details_get_or_set();
                        My_order_details_set.item_code(item_code);
                        My_order_details_set.item_image(item_image);
                        My_order_details_set.item_name(item_name);
                        My_order_details_set.item_packing(item_packing);
                        My_order_details_set.item_expiry(item_expiry);
                        My_order_details_set.item_company(item_company);
                        My_order_details_set.item_scheme(item_scheme);
                        My_order_details_set.item_price(item_price);
                        My_order_details_set.item_quantity(item_quantity);
                        My_order_details_set.item_quantity_price(item_quantity_price);
                        My_order_details_set.item_date_time(item_date_time);
                        My_order_details_set.item_modalnumber(item_modalnumber);
                        My_order_details_List.add(My_order_details_set);
                    }
                    adapter.notifyDataSetChanged();
                    if (My_order_details_List.isEmpty()) {
                ...
                Toast.makeText(getApplicationContext(), "error -- json_My_order_details --" + e.toString(), Toast.LENGTH_LONG).show();
